...
public class WinterToursPage extends BasePage {
	...
	public WinterToursPage fillForm(WinterToursData data) {
		return enterName(data.getName()).enterEmail(data.getEmail()).enterPhone(data.getPhone()).enterMessage(data.getMessage());
	}
